...
public class DepthsGenLayerBiome extends GenLayer
{
    @SuppressWarnings("unchecked")
    private java.util.List<net.minecraftforge.common.BiomeManager.BiomeEntry>[] biomes = new java.util.ArrayList[1];
    private final ChunkProviderSettings settings;

    public DepthsGenLayerBiome(long p_i45560_1_, GenLayer p_i45560_3_, WorldType p_i45560_4_, ChunkProviderSettings p_i45560_5_)
    {
        super(p_i45560_1_);
        ...
        biomes[desertIdx].add(new net.minecraftforge.common.BiomeManager.BiomeEntry(FathomsBiomeRegistry.depthsBiome, 100));
